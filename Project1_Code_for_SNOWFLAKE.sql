...
-- Table `Offices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS DEMO.CLASSICMODELS.`Offices` (
...
-- -----------------------------------------------------
-- Table DEMO.CLASSICMODELS.`employees`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table DEMO.CLASSICMODELS.`customers`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS DEMO.CLASSICMODELS.`Products` (
  ...
  CONSTRAINT `fk_Products_ProductLines`
    ...
    REFERENCES DEMO.CLASSICMODELS."`PRODUCTLINES`" (`productLine`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
--Table for Orders
----------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS DEMO.CLASSICMODELS.`Orders` (
  ...
  CONSTRAINT `fk_Orders_Customers`
    ...
    REFERENCES DEMO.CLASSICMODELS."`CUSTOMERS`" (`CUSTOMERNUMBER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- Table `OrderDetails`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS DEMO.CLASSICMODELS.`OrderDetails` (
  `orderNumber` INT NOT NULL,
  `productCode` VARCHAR(15) NOT NULL,
  ...
  CONSTRAINT `fk_OrderDetails_Products`
    ...
    REFERENCES DEMO.CLASSICMODELS."`PRODUCTS`" (`PRODUCTCODE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_OrderDetails_Orders`
    FOREIGN KEY (`orderNumber`)
    REFERENCES DEMO.CLASSICMODELS."`ORDERS`" (`ORDERNUMBER`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- -----------------------------------------------------
-- Table DEMO.CLASSICMODELS.`Payments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS DEMO.CLASSICMODELS.`Payments` (
